...
# ============================================================================
# [1/21] Баннер + определение OVERLAY_DIR
# ============================================================================
...
# ============================================================================
# [5/21] Установка Python-зависимостей
# ============================================================================
...
# ============================================================================
# [7/21] Создание структуры директорий
# ============================================================================
...
# ============================================================================
# [9/21] Копирование openclaw.json
# ============================================================================
...
# ============================================================================
# [10/21] Копирование файлов workspace
# ============================================================================
...
# ============================================================================
# [11/21] Установка навыков из ClawHub
# ============================================================================
...
# ============================================================================
# [13/21] Онбординг и установка демона
# ============================================================================
...
# ============================================================================
# [14/21] Активация всех хуков и скиллов
# ============================================================================
step "Активация всех хуков и скиллов"

# Включить все доступные хуки
HOOKS_ENABLED=0
HOOKS_FAILED=0

# Получаем список хуков через JSON и включаем не-plugin хуки
while IFS= read -r hook_name; do
    if [[ -n "$hook_name" ]]; then
        if openclaw hooks enable "$hook_name" 2>/dev/null; then
            ok "Хук включён: ${hook_name}"
            HOOKS_ENABLED=$((HOOKS_ENABLED + 1))
        else
...
if (( HOOKS_ENABLED > 0 )); then
    ok "Хуков включено: ${HOOKS_ENABLED}"
fi
if (( HOOKS_FAILED > 0 )); then
    warn "Хуков не удалось включить: ${HOOKS_FAILED}"
fi
if (( HOOKS_ENABLED == 0 && HOOKS_FAILED == 0 )); then
    warn "Хуки не найдены — проверьте позже: openclaw hooks list"
fi

# ============================================================================
# [15/21] Копирование cron/jobs.json
# ============================================================================
...
# ============================================================================
# [20/21] Сохранение версии overlay
# ============================================================================
